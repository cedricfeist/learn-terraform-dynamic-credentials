...
provider "aws" {
  ...
  access_key = data.vault_aws_access_credentials.awsdynamic.awsdynamic.access_key
  secret_key = data.vault_aws_access_credentials.awsdynamic.awsdynamic.secret_key
}
